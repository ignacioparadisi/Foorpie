...
class MenuViewModel {
    ...
    func dishForRow(at indexPath: IndexPath) -> DishViewModel {
        return DishViewModel(dish: filteredDishes[indexPath.row])
    }
    ...
    func detailForRow(at indexPath: IndexPath? = nil) -> DishDetailViewModel {
...
extension MenuViewModel: DishDetailViewModelDelegate {
